...
# 加载和预处理数据
# filePath = '../data/Export_Output.csv'
# filePath = '../xiangyun/data/dongchuan_all.csv'
...
model=torch.load('../xiangyun/data/fire.pth')
with torch.no_grad():
...
# data.to_csv('../dongchuan/data/dongchuan_predict.csv',index=False)
